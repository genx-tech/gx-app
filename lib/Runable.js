...
const Runable = T => class extends T {
  constructor(name, options) {
    ...
    _defineProperty(this, "_getOnUncaughtException", exitOnError => err => {
      if (exitOnError) {
    ...
    _defineProperty(this, "_onWarning", warning => {
      this.log('warn', warning.message);
    });

    _defineProperty(this, "_onExit", code => {
      if (this.started) {
...
//# sourceMappingURL=Runable.js.map