...
class RestClient {
  ...
  async do(method, path, query, body, options) {
    ...
    let httpMethod = (options === null || options === void 0 ? void 0 : options.httpMethod) ?? AllowedMethods[method];
    ...
    if (method === "download") {
      ...
      req.attach((options === null || options === void 0 ? void 0 : options.fileField) ?? "file", body, options === null || options === void 0 ? void 0 : options.fileName);
    } else {
      req.send(body);
    }
